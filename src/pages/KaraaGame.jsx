...
const ingredients = [
  'むね肉', 'もも肉', '手羽先', '手羽元',
  '醤油', '酒', '塩', '胡椒', '砂糖', 'ニンニク', '生姜', '中華スープの素','カレー粉', '片栗粉', '小麦粉',
];
...
const recipes = [
  {
    'もも肉': 3, '醤油': 4, '生姜': 1, 'ニンニク': 3, '片栗粉': 2,
  },
  {
    'むね肉': 2, '酒': 3, '塩': 4, '胡椒': 1, '小麦粉': 2,
  },
  {
    '手羽先': 1, '胡椒': 2, '砂糖': 2, '醤油': 1, '片栗粉': 1,
  },
  {
    '手羽元': 3, '醤油': 2, '中華スープの素': 1, 'カレー粉': 5, '小麦粉': 3,
  },
  {
    'もも肉': 2, '酒': 3, '生姜': 2, '塩': 5, '片栗粉': 3,
  },
  {
    'むね肉': 2, '醤油': 2, '胡椒': 4, '砂糖': 1, '小麦粉': 3,
  },
  {
    '手羽先': 3, 'ニンニク': 3, '塩': 4, '酒': 2, '片栗粉': 2,
  },
  {
    '手羽元': 2, '胡椒': 2, '醤油': 2, '生姜': 2, '小麦粉': 1,
  },
  {
    'もも肉': 2, 'ニンニク': 6, '酒': 5, 'カレー粉': 5, '片栗粉': 2,
  },
  {
    'むね肉': 4, '醤油': 1, '生姜': 1, '砂糖': 4, '小麦粉': 5,
  },
  {
    '手羽先': 2, '胡椒': 5, '塩': 2, '酒': 1, '片栗粉': 3,
  },
  {
    '手羽元': 3, 'ニンニク': 3, '醤油': 2, '中華スープの素': 6, '小麦粉': 3,
  },
  {
    'もも肉': 4, '胡椒': 3, '塩': 1, '醤油': 2, '片栗粉': 4,
  },
  {
    'むね肉': 6, 'ニンニク': 3, '酒': 4, '生姜': 4, '小麦粉': 5,
  },
  {
    '手羽先': 3, '中華スープの素': 3, 'カレー粉': 5, '酒': 2, '片栗粉': 1,
  },
  {
    '手羽元': 2, '醤油': 3, '生姜': 4, '砂糖': 1, '小麦粉': 1
  }]
          ...
          <div className="max-w-[85rem] px-4 py-1 sm:px-6 lg:px-8 md:py-2 lg:py-2 mx-auto  bg-white border border-gray-200 rounded-xl shadow-sm">
            <div className="grid sm:grid-cols-2">
              ...
              <div className="p-1 md:p-1">
                <div>
                  {/* 成功回数を示すアイコン */}
                  <svg className="flex-shrink-0 size-10 text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  ...
                  <div className="p-1.5 min-w-full inline-block align-middle">
                    <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden ">
                      <div className="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 ">
                        <h2 className="text-xl font-semibold text-gray-800 ">現在のオーダー</h2>
                      </div>
                      <table className="min-w-full divide-y divide-gray-200 ">
                        <thead className="bg-gray-50 ">
                          <tr>
                            <th scope="col" className="px-6 py-3 text-left text-xl font-semibold uppercase tracking-wider text-gray-800 ">
                              材料
                            </th>
                            <th scope="col" className="px-6 py-3 text-left text-xl font-semibold uppercase tracking-wider text-gray-800 ">
                              量
                      ...
                      <tbody className="bg-white divide-y divide-gray-200 ">
                        {Object.entries(currentRecipe).map(([ingredient, quantity]) => (
                        <tr key={ingredient}>
